...
public class UIManager : MonoBehaviour
{
    ...
    [Header("Drawing Toolbar")]
    [Tooltip("Optional: an Image whose color updates to preview the currently selected brush color (useful after using the color picker tool).")]
    [SerializeField] private Image currentColorSwatch;
    ...
    // ---------- Drawing toolbar callbacks ----------

    /// <summary>Called by DrawingCanvas when the color picker tool is used.</summary>
    public void OnColorPicked(Color color)
    {
        if (currentColorSwatch != null)
            currentColorSwatch.color = color;
    }
